...
/***/ function(module, exports, __webpack_require__) {
	...
	var profEvents = __webpack_require__(12);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://rocky-meadow-90201.herokuapp.com/',
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(function () {
	    api.signIn(signInData).then(function (response) {
	      ...
	      return store.user;
	    }).then(ui.signUpSuccess).catch(ui.failure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateProfile = function onCreateProfile(event) {
	  ...
	  api.profile(data).then(ui.createProfileSuccess).catch(ui.failure);
	};
	...
	var onUpdateProfile = function onUpdateProfile(event) {
	  ...
	  api.updateProfile(store.user.id, data).then(ui.onUpdateProfile).catch(ui.failure);
	};
	...
	var profHandlers = function profHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateProfile = function updateProfile(id, data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateProfile = function onUpdateProfile() {};
